...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "Inspect.Mobile.Android.dll" comes first in this list. */
		"Inspect.Mobile.Android.dll",
		"Acr.UserDialogs.dll",
		"AndHUD.dll",
		"AutoMapper.dll",
		"Com.Panasonic.Toughpad.Android.dll",
		...
		"FormsViewGroup.dll",
		"Inspect.Mobile.dll",
		"Inspect.Mobile.Framework.Android.dll",
		"Inspect.Mobile.Framework.Android.Toughpad.dll",
		"Inspect.Mobile.Framework.Xamarin.dll",
		...
		"Inspect.Framework.Hypermedia.dll",
		"Newtonsoft.Json.dll",
		"Inspect.FireSafety.Mobile.dll",
		"Inspect.FireSafety.WebApi.Contracts.dll",
		"Inspect.Core.Mobile.dll",
	};
